...
class semantico implements semanticoConstants {
        public static void main( String[] args )throws ParseException, Exception
        {
                ...
                semantico analizador = new semantico(entrada) ;
                        analizador.Programa();
                        System.out.println("\u005ct =>**** Fin del Analisis **** <=.");
                ...
                catch(ParseException e)
                {
                        ...
                        System.out.println("\u005ct =>**** Fin del Analisis **** <=.");
                    System.out.println("\u005ct =>**** Hubo algun problema con el archivo de entrada **** <=.");
                }
...
//Declaracion de las variables en general
  static final public void VariablesGlobales() throws ParseException {int intTD;
Token tok_var;
    TiposDatos();
intTD = token.kind;
    jj_consume_token(DOSPUNTOS);
    tok_var = jj_consume_token(IDENTIFICADOR);
...
//Declaracion de vectores
  static final public void vector(Token tok_var) throws ParseException {
...
//Declaracion de varibles globales
  static final public void dec_glob(Token tok_var) throws ParseException {Token par;
TokenAsignaciones.insertarSimbolo(tok_var,tok_var);
    label_3:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
TokenAsignaciones.insertarSimbolo(par,tok_var);
    }
    jj_consume_token(PUNTOYCOMA);
  }

//Declaracion Funciones
  static final public void funcion(Token tok_var) throws ParseException {int intTD;
 Token par;
...
intTD = token.kind;
        jj_consume_token(DOSPUNTOS);
        par = jj_consume_token(IDENTIFICADOR);
par= new Token (intTD, par.image); TokenAsignaciones.insertarParametros(tok_var,par);
        break;
        }
      case COMA:{
        jj_consume_token(COMA);
...
intTD = token.kind;
        jj_consume_token(DOSPUNTOS);
        par = jj_consume_token(IDENTIFICADOR);
par= new Token (intTD, par.image);
 TokenAsignaciones.insertarParametros(tok_var,par);
        break;
        }
      default:
        jj_la1[5] = jj_gen;
...
//Parte inicial de las declaraciones
  static final public Token tok_var() throws ParseException {int intTD;
  Token tok_var;
    TiposDatos();
intTD = token.kind;
    jj_consume_token(DOSPUNTOS);
    tok_var = jj_consume_token(IDENTIFICADOR);
tok_var= new Token (intTD,tok_var.image);
{if ("" != null) return tok_var;}
    throw new Error("Missing return statement in function");
  }

//Parametros de las funciones
  static final public Token parametros() throws ParseException {Token par=null;
    label_5:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case COMA:
...
// Implementacion de las funciones
  static final public void Implementa_Funciones() throws ParseException {int t1,t2;
Token tok_var,par;
    TiposDatos();
t1 = token.kind;
    jj_consume_token(DOSPUNTOS);
    tok_var = jj_consume_token(IDENTIFICADOR);
tok_var= new Token (t1, tok_var.image);
    jj_consume_token(PARIZQ);
...
t2 = token.kind;
        jj_consume_token(DOSPUNTOS);
        par = jj_consume_token(IDENTIFICADOR);
par= new Token (t2, par.image); TokenAsignaciones.verificarFuncion2(tok_var,par);
        break;
        }
      case COMA:{
        jj_consume_token(COMA);
...
//Cuerpo de las funciones
  static final public void cuerpo_Fun(Token tok_var) throws ParseException {Token nombre_Fun;
    jj_consume_token(LLAVEIZQ);
    Sentencias();
    jj_consume_token(RETURN);
    nombre_Fun = jj_consume_token(IDENTIFICADOR);
    jj_consume_token(PUNTOYCOMA);
    jj_consume_token(LLAVEDER);
  }

//Variables locales 
  static final public void VariablesLocales() throws ParseException {int intTD;
        Token tok_var;
    TiposDatos();
intTD = token.kind;
    jj_consume_token(DOSPUNTOS);
  ...
  static private boolean jj_3R_16()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0xd100000,0x8000000,0x8000000,0x8000000,0x8000000,0x8000000,0x8000000,0x8000000,0x2,0x8000000,0x2,0x3c,0x69000,0x9000,0x60000,0x0,0x4000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c,0x0,0x0,0x4,0x4,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1f00,0x1f00,0x0,0x0,0x1f00,0x1f00,0x1f00,0x1f00,0x1f00,0x1f00,0x0,0x0,0x0,0x7e000,0x9f00,0x1f00,0x0,0x1f00,0x0,0xa0c0,0xc0,0xc0,0xa000,0xa000,0xa000,0xa000,0xa000,0xa000,0x3f,0x0,0x7e000,0x2a000,0x0,0x0,0x2a000,};
   }
